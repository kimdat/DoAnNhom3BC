...
function Validation()
{
    ...
    var errorName = "";
    var errorLocation = "";
    $(".educationform  .name_school").each(function () {
        
        countName++;
        if ($(this).val().trim() == "") {
           
           
                errorName += "Name _school " + countName + " not null,";
    ...
    var countLocation = 0;
    $(".educationform  .location").each(function () {

        countLocation++;
        if ($(this).val().trim() == "") {
          

                errorLocation += "Location " + countLocation + " not null,";
            flag = false;
        }
    });
    if (flag == false)
    {
       ...
       errorLocation = errorLocation.substr(0,errorLocation.length - 1);
        $("#ModalValid .modal-body p").html(errorName + "<br/>" + errorLocation);
        $(".modalValid").click();
        return false;
    }
...
$("input[name='fileUser']").change(function () {
    ...
    var val = $(this).val().toLowerCase(),
        regex = new RegExp("(.*?)\.(jpg|png|jpeg|jpe|jfif)$");
...
$("input[name='file']").change(function () {
    var val = $(this).val().toLowerCase(),
        regex = new RegExp("(.*?)\.(docx|doc|docm|docx|dot|dotx|ppt|pptm|pptx|xlm|xls|xlsm|xlsx)$");
